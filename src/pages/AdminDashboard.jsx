    ...
    <div className="space-y-12">
      ...
      {isFormOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-900/60 backdrop-blur-sm p-4 animate-in fade-in duration-300">
          <div className="bg-white dark:bg-slate-900 w-full max-w-4xl max-h-[90vh] overflow-y-auto rounded-[3.5rem] p-8 md:p-12 shadow-2xl border border-gray-200 dark:border-slate-800 space-y-10 relative">
            <button 
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="space-y-2">
                <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-2">Content (Markdown supported)</label>
                <textarea 
                  required 
                  rows={15}
